...
const classNames = {
  ...
  carousel: 'carousel',
  carouselControl: 'carousel__control',
  carouselControlCaption: 'carousel__control-caption',
  carouselControlIcon: 'carousel__control-icon',
  carouselControlNext: 'carousel__control_next',
  carouselControlPrevious: 'carousel__control_previous',
  carouselFrame: 'carousel__frame',
  carouselItem: 'carousel__item',
  carouselList: 'carousel__list',
  carouselMedia: 'carousel__media',
  carouselRadio: 'carousel__radio',
  carouselView: 'carousel__view',
  clearFix: 'clearfix',
  code: 'code',
